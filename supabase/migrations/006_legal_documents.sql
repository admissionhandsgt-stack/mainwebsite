...
-- Stores all legal content as Markdown documents
...
-- Allow public read access for published documents
CREATE POLICY "Allow public read access to published legal documents"
  ON legal_documents
  FOR SELECT
...
INSERT INTO legal_documents (slug, title, content, is_published, last_updated) VALUES
(
  'terms',
  'Terms of Service',
  '## Introduction
