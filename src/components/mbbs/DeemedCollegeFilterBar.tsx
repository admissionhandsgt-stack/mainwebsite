...
export function DeemedCollegeFilterBar({
  ...
  return (
    <div className="sticky top-[72px] lg:top-[112px] z-[30] bg-white/95 backdrop-blur-lg border-b border-slate-100 shadow-sm w-full overflow-hidden">
        ...
        <div className="overflow-x-auto w-full -mx-4 px-4 scrollbar-none">
          <div className="flex items-center gap-2 pb-1 min-w-[620px] md:min-w-0 md:flex-wrap">
            ...
            <select
              ...
              className="px-3 py-2 rounded-lg bg-slate-50 border border-slate-200 text-xs font-bold text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-300 transition-all appearance-none cursor-pointer min-w-[120px] md:ml-auto"
            >
