...
export const MBBSEligibilityInfo = () => {
  ...
  return (
    <section className="py-16 md:py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-50/50 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2 pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-indigo-50/50 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/2 pointer-events-none" />
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-100/50 text-blue-600 text-[10px] font-black tracking-widest uppercase mb-4"
          >
          ...
          >
            Eligibility & <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Key Insights</span>
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="text-slate-500 font-medium md:text-lg"
          >
          ...
          <div className="flex flex-col h-full">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 font-medium mt-1">Minimum requirements to apply.</p>
              </div>
            </div>
              ...
              {eligibility.criteria.map((text, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className="p-6 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-xl hover:border-emerald-200 transition-all duration-300 group flex items-start gap-5"
                  >
                    <div className="w-12 h-12 rounded-xl bg-slate-50 flex items-center justify-center shrink-0 group-hover:bg-emerald-50 group-hover:text-emerald-600 transition-colors text-slate-400">
                      <EligIcon className="w-6 h-6" />
                    </div>
                    <div>
                      <h4 className="text-base font-black text-slate-900 mb-1.5">{criteriaTitles[idx] || "Requirement"}</h4>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-4">
                        {documents.list.map((doc, idx) => (
                          <div key={idx} className="flex items-start gap-3">
                            ...
                            <span className="text-sm font-bold text-slate-700 leading-snug">{doc}</span>
                          </div>
                        ))}
                      </div>
          ...
          <div className="flex flex-col h-full">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 font-medium mt-1">Crucial factors deciding your seat.</p>
              </div>
            </div>
              ...
              {eligibility.usefulInfo?.map((info, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className="p-6 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-xl hover:border-blue-200 transition-all duration-300 group flex items-start gap-5"
                  >
                    <div className="w-12 h-12 rounded-xl bg-slate-50 flex items-center justify-center shrink-0 group-hover:bg-blue-50 group-hover:text-blue-600 transition-colors text-slate-400">
                      <InsightIcon className="w-6 h-6" />
                    </div>
                    <div>
                      <h4 className="text-base font-black text-slate-900 mb-1.5">{info.title}</h4>
            ...
            {/* Info Banner */}
            <div className="mt-4 p-6 rounded-2xl bg-blue-50 border border-blue-100 flex items-start gap-4">
