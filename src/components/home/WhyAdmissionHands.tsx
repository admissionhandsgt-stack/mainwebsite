...
const WhyAdmissionHands = () => {
  return (
    <section className="compact-padding bg-slate-50 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl h-full bg-blue-100/40 blur-[100px] rounded-full pointer-events-none" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-left">
              {["95% Success Rate", "2100+ Families Guided", "Pan-India Coverage", "Zero Hidden Fees"].map((point, i) => (
                ...
                >
                  ...
                  <span className="text-slate-700 font-bold text-xs sm:text-sm tracking-tight">{point}</span>
                </motion.div>
              ))}
            </div>
          </div>
